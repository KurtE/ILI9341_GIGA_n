...
void TransitionSquares::init( ILI9341_GIGA_n tft ) {

}

void TransitionSquares::restart( ILI9341_GIGA_n tft, uint_fast16_t inColor ) {
...
void TransitionSquares::perFrame( ILI9341_GIGA_n tft, FrameParams frameParams ) {
