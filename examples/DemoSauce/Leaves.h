...
public:
	...
	void init( ILI9341_GIGA_n tft );
	uint_fast16_t bgColor( void );
	String title();
	void perFrame( ILI9341_GIGA_n tft, FrameParams frameParams );

private:
  void _drawLeaves( ILI9341_GIGA_n tft, boolean doErase, uint_fast8_t iter, float radius, float spin, float x, float y, uint_fast16_t solidColor, uint_fast16_t outlineColor );

  float _phase = 0;
  uint_fast16_t _bgColor;
};

void Leaves::init( ILI9341_GIGA_n tft ) {
  _bgColor = 0x780f;
}
...
void Leaves::_drawLeaves( ILI9341_GIGA_n tft, boolean doErase, uint_fast8_t iter, float radius, float spin, float x, float y, uint_fast16_t solidColor, uint_fast16_t outlineColor ) {
...
void Leaves::perFrame( ILI9341_GIGA_n tft, FrameParams frameParams ) {
