...
void TransitionDither::init( ILI9341_GIGA_n tft ) {

}

void TransitionDither::restart( ILI9341_GIGA_n tft, uint_fast16_t inColor ) {
...
void TransitionDither::perFrame( ILI9341_GIGA_n tft, FrameParams frameParams ) {
