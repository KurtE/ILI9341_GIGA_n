...
void TwistyText::init( ILI9341_GIGA_n tft ) {
...
void TwistyText::reset( ILI9341_GIGA_n tft ) {
...
void TwistyText::perFrame( ILI9341_GIGA_n tft, FrameParams frameParams ) {
