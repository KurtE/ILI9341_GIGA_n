...
public:
  ...
  void init( ILI9341_GIGA_n tft );
	void restart( ILI9341_GIGA_n tft, uint_fast16_t color );
...
void TransitionHalftone::init( ILI9341_GIGA_n tft ) {

}

void TransitionHalftone::restart( ILI9341_GIGA_n tft, uint_fast16_t inColor ) {
...
void TransitionHalftone::perFrame( ILI9341_GIGA_n tft, FrameParams frameParams ) {
