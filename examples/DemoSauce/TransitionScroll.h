...
void TransitionScroll::init( ILI9341_GIGA_n tft ) {
	_pixels = (uint16_t*)malloc( sizeof(uint_fast16_t) * tft.width() );
}

void TransitionScroll::restart( ILI9341_GIGA_n tft, uint_fast16_t inColor ) {
...
void TransitionScroll::perFrame( ILI9341_GIGA_n tft, FrameParams frameParams ) {
